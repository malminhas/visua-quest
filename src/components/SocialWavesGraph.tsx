        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
          ...
          <SocialWave className="animate-fade-in animated-element">
            ...
            <div className="flex justify-between items-center mt-4">
              <div className="w-10 h-10 bg-blue-600 rounded-md flex items-center justify-center p-1">
                <img src="/lovable-uploads/9f25f7a1-64eb-463d-b1e1-1d454b7437e0.png" alt="MySpace Logo" className="w-full h-full object-contain" />
              </div>
              <div className="w-10 h-10 bg-black rounded-md flex items-center justify-center p-1">
                <img src="/lovable-uploads/9f25f7a1-64eb-463d-b1e1-1d454b7437e0.png" alt="Hi5 Logo" className="w-full h-full object-contain" />
              </div>
              <div className="w-10 h-10 bg-green-500 rounded-md flex items-center justify-center p-1">
              ...
              <div className="w-10 h-10 bg-teal-400 rounded-md flex items-center justify-center p-1">
          ...
          <SocialWave className="animate-fade-in animated-element">
            ...
            <div className="flex justify-between items-center mt-4">
              <div className="w-10 h-10 bg-blue-700 rounded-md flex items-center justify-center p-1">
              ...
              <div className="w-10 h-10 bg-gradient-to-r from-purple-500 to-pink-500 rounded-md flex items-center justify-center p-1">
              ...
              <div className="w-10 h-10 bg-blue-400 rounded-md flex items-center justify-center p-1">
                <img src="/lovable-uploads/9f25f7a1-64eb-463d-b1e1-1d454b7437e0.png" alt="Twitter Logo" className="w-full h-full object-contain" />
              </div>
              <div className="w-10 h-10 bg-blue-800 rounded-md flex items-center justify-center p-1">
          ...
          <SocialWave className="animate-fade-in animated-element">
            ...
            <div className="flex justify-between items-center mt-4">
              <div className="w-10 h-10 bg-gradient-to-r from-purple-600 to-blue-400 rounded-md flex items-center justify-center p-1">
                <img src="/lovable-uploads/9f25f7a1-64eb-463d-b1e1-1d454b7437e0.png" alt="Replika Logo" className="w-full h-full object-contain" />
              </div>
              <div className="w-10 h-10 bg-pink-600 rounded-md flex items-center justify-center p-1">
              ...
              <div className="w-10 h-10 bg-gradient-to-r from-blue-600 to-blue-800 rounded-md flex items-center justify-center p-1">
                <img src="/lovable-uploads/9f25f7a1-64eb-463d-b1e1-1d454b7437e0.png" alt="ChatGPT Logo" className="w-full h-full object-contain" />
              </div>
              <div className="w-10 h-10 bg-orange-500 rounded-md flex items-center justify-center p-1">
                <img src="/lovable-uploads/9f25f7a1-64eb-463d-b1e1-1d454b7437e0.png" alt="Claude Logo" className="w-full h-full object-contain" />
              </div>
              <div className="w-10 h-10 bg-teal-700 rounded-md flex items-center justify-center p-1">
